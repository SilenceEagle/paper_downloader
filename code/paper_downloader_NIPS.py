    ...
    with open(f'..\\csv\\NIPS_{year}.csv', newline='') as csvfile:
        ...
        for this_paper in pbar:
            ...
            if total_paper_number is not None:
                pbar.set_description(f'Downloading paper {i}/{total_paper_number}: {title}')

            else:
                pbar.set_description(f'Downloading paper {i}: {title}')
...
if __name__ == '__main__':
    ...
    #     downloader='IDM')
    # rename_supp(year, supp_dir=r'G:\xl_download\tmp')
    move_main_and_supplement_2_one_directory(
        main_path=r'F:\workspace\python3_ws\paper_downloader-master\NIPS_2020\main_paper',
        supplement_path=r'F:\workspace\python3_ws\paper_downloader-master\NIPS_2020\supplement',
        supp_pdf_save_path=r'F:\workspace\python3_ws\paper_downloader-master\NIPS_2020\supplement_pdf3'
    )
