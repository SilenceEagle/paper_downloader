...
def get_paper_dict_list(url=None, content=None, group_name=None):
    """
    ...
    paper_dict_list = []
    paper_dict = {'title': '', 'main link': '', 'supplemental link': ''} if group_name is None else \
        {'group': group_name, 'title': '', 'main link': '', 'supplemental link': ''}
