...
*paper_download_ECCV_IDM.py* uses the IDM to download ECCV 2018-present papers, the supplemental material will be merged with the main paper into one folder.
